use land_plot_staking::{
    constants::{errors::ERR_NOT_ENOUGH_STAKED, score::LAND_PLOT_SCORES},
...
use crate::test_state::{
    KosonV2NftStakingContractState, EGLD_PRICE_FEED_NAME, INITIAL_ESDT_BALANCE,
    INITIAL_SFT_BALANCE, KOSON_TOKEN_ID, NFT_STAKING_TOKEN_ID, OURO_TOKEN_ID, USDC_TOKEN_ID,
    USDD_TOKEN_ID, USER_1_ADDRESS_EXPR, WEGLD_TOKEN_ID,
};
...
fn simple_stake_unstake_sends_asset_to_caller() {
    ...
    apply_default_scenario_setup(&mut state)
        ...
        .check_user_nft_balance(
            USER_1_ADDRESS_EXPR,
            NFT_STAKING_TOKEN_ID,
            1,
            INITIAL_SFT_BALANCE,
        );
}
...
fn sending_more_fee_token_returns_remainder() {
    let unstake_fee_amount = 2499999999999999999u128 * 15 / 25;
