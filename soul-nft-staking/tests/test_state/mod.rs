...
pub const DEATH_SOUL_TOKEN_ID: &str = "DEATHSOUL-abcdef";
pub const ORIGIN_SOULS_TOKEN_IDS: [&str; 6] = [
    "WATER-abcdef",
    "EARTH-ghijkl",
    "AIR-ghijkl",
    "ETHEREAL-ghijkl",
...
pub const SUMMONED_ORIGIN_SOULS_TOKEN_IDS: [&str; 6] = [
    "SWATER-abcdef",
    "SEARTH-ghijkl",
    "SAIR-ghijkl",
    "SETHEREAL-ghijkl",
...
type KosonV2NftStakingContract = ContractInfo<soul_nft_staking::Proxy<StaticApi>>;
